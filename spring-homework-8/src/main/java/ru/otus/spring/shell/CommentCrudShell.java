...
public class CommentCrudShell {
    ...
    public void updateCommentTextById(@ShellOption String id, @ShellOption String newText) {
    ...
    @ShellMethod(value = "Save comment (example: sc comment_text_new 1)",
            key = {"sc", "save comment"})
    public void saveComment(@ShellOption String title, @ShellOption String bookId) {
