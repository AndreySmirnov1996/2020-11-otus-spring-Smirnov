...
public class BookCrudShell {
    ...
    @ShellMethod(value = "Delete book by id (example: db 60259035b68c172f2b9d67ef)", key = {"db"})
    public void deleteBookById(@ShellOption String bookId) {
        bookCrudService.deleteBookById(bookId);
    }

    @ShellMethod(value = "Update title book by id (example: ubt 6025923474813e50a37ea44a new_title)", key = {"ubt"})
    ...
    @ShellMethod(value = "Show all books with all info (example: sab)", key = {"sab"})
    public void showAllBooks() {
        bookCrudService.showAllBooks();
    }

    @ShellMethod(value = "Show book by id (example: sbid 60259035b68c172f2b9d67ef)", key = {"sbid"})
    ...
    @ShellMethod(value = "Save book (example: sb book_name 1 111;Name1,Surname1) (sb book)",
            key = {"sb", "save book"})
