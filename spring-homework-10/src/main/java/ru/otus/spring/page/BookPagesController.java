...
public class BookPagesController {
    ...
    public String deleteBookOld(@RequestParam long id) {
    ...
    public String editBook(@PathVariable("id") long id, Model model) throws ChangeSetPersister.NotFoundException {
        Book book = bookCrudService.findById(id).orElseThrow(ChangeSetPersister.NotFoundException::new);
